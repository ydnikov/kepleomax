...
mixin _$CallData {
 ...
 User get otherUser; RTCPeerConnectionState get connectionState; RTCVideoRenderer? get localRenderer; RTCVideoRenderer? get remoteRenderer; DateTime? get callStartedTime; bool get isLocalCameraOn; bool get isRemoteCameraOn; bool get isLocalMicrophoneOn; bool get isCallAccepted;
...
@override
int get hashCode => Object.hash(runtimeType,otherUser,connectionState,localRenderer,remoteRenderer,callStartedTime,isLocalCameraOn,isRemoteCameraOn,isLocalMicrophoneOn,isCallAccepted);

@override
String toString() {
  return 'CallData(otherUser: $otherUser, connectionState: $connectionState, localRenderer: $localRenderer, remoteRenderer: $remoteRenderer, callStartedTime: $callStartedTime, isLocalCameraOn: $isLocalCameraOn, isRemoteCameraOn: $isRemoteCameraOn, isLocalMicrophoneOn: $isLocalMicrophoneOn, isCallAccepted: $isCallAccepted)';
}
...
@useResult
$Res call({
 User otherUser, RTCPeerConnectionState connectionState, RTCVideoRenderer? localRenderer, RTCVideoRenderer? remoteRenderer, DateTime? callStartedTime, bool isLocalCameraOn, bool isRemoteCameraOn, bool isLocalMicrophoneOn, bool isCallAccepted
});
...
/// Create a copy of CallData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? otherUser = null,Object? connectionState = null,Object? localRenderer = freezed,Object? remoteRenderer = freezed,Object? callStartedTime = freezed,Object? isLocalCameraOn = null,Object? isRemoteCameraOn = null,Object? isLocalMicrophoneOn = null,Object? isCallAccepted = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( User otherUser,  RTCPeerConnectionState connectionState,  RTCVideoRenderer? localRenderer,  RTCVideoRenderer? remoteRenderer,  DateTime? callStartedTime,  bool isLocalCameraOn,  bool isRemoteCameraOn,  bool isLocalMicrophoneOn,  bool isCallAccepted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CallData() when $default != null:
return $default(_that.otherUser,_that.connectionState,_that.localRenderer,_that.remoteRenderer,_that.callStartedTime,_that.isLocalCameraOn,_that.isRemoteCameraOn,_that.isLocalMicrophoneOn,_that.isCallAccepted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( User otherUser,  RTCPeerConnectionState connectionState,  RTCVideoRenderer? localRenderer,  RTCVideoRenderer? remoteRenderer,  DateTime? callStartedTime,  bool isLocalCameraOn,  bool isRemoteCameraOn,  bool isLocalMicrophoneOn,  bool isCallAccepted)  $default,) {final _that = this;
switch (_that) {
case _CallData():
return $default(_that.otherUser,_that.connectionState,_that.localRenderer,_that.remoteRenderer,_that.callStartedTime,_that.isLocalCameraOn,_that.isRemoteCameraOn,_that.isLocalMicrophoneOn,_that.isCallAccepted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( User otherUser,  RTCPeerConnectionState connectionState,  RTCVideoRenderer? localRenderer,  RTCVideoRenderer? remoteRenderer,  DateTime? callStartedTime,  bool isLocalCameraOn,  bool isRemoteCameraOn,  bool isLocalMicrophoneOn,  bool isCallAccepted)?  $default,) {final _that = this;
switch (_that) {
case _CallData() when $default != null:
return $default(_that.otherUser,_that.connectionState,_that.localRenderer,_that.remoteRenderer,_that.callStartedTime,_that.isLocalCameraOn,_that.isRemoteCameraOn,_that.isLocalMicrophoneOn,_that.isCallAccepted);case _:
  return null;
...
class _CallData implements CallData {
  const _CallData({required this.otherUser, this.connectionState = RTCPeerConnectionState.RTCPeerConnectionStateDisconnected, this.localRenderer, this.remoteRenderer, this.callStartedTime, this.isLocalCameraOn = true, this.isRemoteCameraOn = true, this.isLocalMicrophoneOn = true, this.isCallAccepted = false});
...
/// Create a copy of CallData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? otherUser = null,Object? connectionState = null,Object? localRenderer = freezed,Object? remoteRenderer = freezed,Object? callStartedTime = freezed,Object? isLocalCameraOn = null,Object? isRemoteCameraOn = null,Object? isLocalMicrophoneOn = null,Object? isCallAccepted = null,}) {
