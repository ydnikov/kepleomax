...
mixin _$MessageDto {
 ...
 int get id; int get chatId; int get senderId; bool get isCurrentUser; String get message; String get type; bool get isRead; int get createdAt; int? get editedAt; bool get fromCache;
...
@override
int get hashCode => Object.hash(runtimeType,id,chatId,senderId,isCurrentUser,message,type,isRead,createdAt,editedAt,fromCache);

@override
String toString() {
  return 'MessageDto(id: $id, chatId: $chatId, senderId: $senderId, isCurrentUser: $isCurrentUser, message: $message, type: $type, isRead: $isRead, createdAt: $createdAt, editedAt: $editedAt, fromCache: $fromCache)';
}
...
@useResult
$Res call({
 int id, int chatId, int senderId, bool isCurrentUser, String message, String type, bool isRead, int createdAt, int? editedAt, bool fromCache
});
...
/// Create a copy of MessageDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? chatId = null,Object? senderId = null,Object? isCurrentUser = null,Object? message = null,Object? type = null,Object? isRead = null,Object? createdAt = null,Object? editedAt = freezed,Object? fromCache = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int chatId,  int senderId,  bool isCurrentUser,  String message,  String type,  bool isRead,  int createdAt,  int? editedAt,  bool fromCache)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MessageDto() when $default != null:
return $default(_that.id,_that.chatId,_that.senderId,_that.isCurrentUser,_that.message,_that.type,_that.isRead,_that.createdAt,_that.editedAt,_that.fromCache);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int chatId,  int senderId,  bool isCurrentUser,  String message,  String type,  bool isRead,  int createdAt,  int? editedAt,  bool fromCache)  $default,) {final _that = this;
switch (_that) {
case _MessageDto():
return $default(_that.id,_that.chatId,_that.senderId,_that.isCurrentUser,_that.message,_that.type,_that.isRead,_that.createdAt,_that.editedAt,_that.fromCache);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int chatId,  int senderId,  bool isCurrentUser,  String message,  String type,  bool isRead,  int createdAt,  int? editedAt,  bool fromCache)?  $default,) {final _that = this;
switch (_that) {
case _MessageDto() when $default != null:
return $default(_that.id,_that.chatId,_that.senderId,_that.isCurrentUser,_that.message,_that.type,_that.isRead,_that.createdAt,_that.editedAt,_that.fromCache);case _:
  return null;
...
class _MessageDto extends MessageDto {
  const _MessageDto({required this.id, required this.chatId, required this.senderId, required this.isCurrentUser, required this.message, required this.type, required this.isRead, required this.createdAt, required this.editedAt, required this.fromCache}): super._();
...
/// Create a copy of MessageDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? chatId = null,Object? senderId = null,Object? isCurrentUser = null,Object? message = null,Object? type = null,Object? isRead = null,Object? createdAt = null,Object? editedAt = freezed,Object? fromCache = null,}) {
